...
class RefundNoteFormRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'refund_note_no' => 'nullable|string|unique:refund_notes,refund_note_no,' . $this->id,
            ...
            'items' => [
                ...
                function ($attribute, $value, $fail) {
                    ...
                    if ($validItems > 8) {
                        $fail('Maximum of 8 valid items allowed per refund note.');
                    }
                }
            ],
    ...
    {
        return [
            'refund_note_no.required' => 'Refund note number is required',
            'refund_note_no.unique' => 'Refund note number must be unique',
