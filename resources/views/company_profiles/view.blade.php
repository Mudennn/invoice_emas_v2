            ...
            <div class="card">
                <div class="card-header form-inline"> 
                    <div class="col-6 font-weight-bold pl-0"><i class="nav-icon  fas fa-file fa-2x text-secondary pr-3"></i>
                        <span class="header-title">COMPANY PROFILES</span> 
                    </div>
                        ...
                        <div class="col-md-6 mt-3 d-inline-block">
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-12 ml-1" style="text-align: right">
                                    <a href="{{ route('company_profiles.index') }}" class="btn btn-xs btn-outline-secondary pull-right"><i class="nav-icon fas fa-arrow-left"></i> Back</a>
                                </div>
                            </div>
