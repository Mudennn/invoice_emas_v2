                    ...
                    <tr>
                        ...
                        <th class="text-end">
                            <input type="number" step="0.01" name="subtotal"
                                ...
                                value="{{ old('subtotal') ?? ($invoice->invoiceItems->first()->subtotal ?? '0.00') }}"
                                readonly>
                        </th>
                        <th class="text-end">
                            <input type="number" step="0.01" name="total_return_balance"
                                class="form-control text-end total-return-balance-input"
                                value="{{ old('remark_total') ?? ($invoice->invoiceItems->first()->remark_total ?? '0.00') }}"
                                readonly>
                        </th>
                        @if (!isset($ro) || $ro === '')
                            <th></th>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="other_tin" class="form-control"
                            value="{{ old('other_tin') }}">
                    </div>
