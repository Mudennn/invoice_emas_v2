<script>
    /**
 * Self-Billed Invoice Form Specific JavaScript
 * 
 * This file initializes the FormHandler for self-billed invoice forms.
 */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Create form handler instance with self-billed invoice-specific configuration
    const selfBilledInvoiceForm = new FormHandler({
        formType: 'self_billed_invoices',
    ...
    // Any self-billed invoice-specific customizations can be added here
